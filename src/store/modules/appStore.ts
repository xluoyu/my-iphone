...
const LoakStore = {
  ...
  state():IState {
    return {
      myAppIds: ['weather', 'appStore', 'photos', 'music', 'camera', 'calculator', 'clock', 'alipay', 'camera2', 'calculator2', 'messages2', 'clock2', 'camera3', 'calculator3', 'messages3', 'clock3', 'camera4', 'calculator4', 'messages4', 'clock4']
    }
  },
  getters: {
